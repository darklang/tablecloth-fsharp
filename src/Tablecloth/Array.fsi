...
val inline sum: 'a t -> 'a when 'a: (static member (+): 'a * 'a -> 'a) and 'a: (static member Zero: 'a)
...
val groupBy: ('value -> 'key) -> 'value t -> Map<'key, 'value list> when 'key: comparison
...
val group_by: ('value -> 'key) -> 'value t -> Map<'key, 'value list> when 'key: comparison
