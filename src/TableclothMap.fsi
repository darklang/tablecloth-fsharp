...
//  *)
//
val update: key: 'key -> f: ('value option -> 'value option) -> t<'key, 'value> -> t<'key, 'value>
...
val filterWithIndex: f: ('key -> 'value -> bool) -> t<'key, 'value> -> t<'key, 'value>
(** Keep elements that [f] returns [true] for.
...
val filter_with_index: f: ('key -> 'value -> bool) -> t<'key, 'value> -> t<'key, 'value>

val partition: f: ('key -> 'value -> bool) -> t<'key, 'value> -> t<'key, 'value> * t<'key, 'value>
